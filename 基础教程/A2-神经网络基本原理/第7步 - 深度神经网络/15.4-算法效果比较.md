...
|||
|---|---|
|<img src="./img/15/op_sgd_ch04.png">|<img src="./img/15/op_sgd2_ch04.png">|
|SGD当学习率为0.1时，需要很多次迭代才能逐渐向中心靠近|SGD当学习率为0.5时，会比较快速地向中心靠近，但是在中心的附近有较大震荡|
|<img src="./img/15/op_momentum_ch04.png">|<img src="./img/15/op_nag_ch04.png">|
|Momentum由于惯性存在，一下子越过了中心点，但是很快就会得到纠正|Nag是Momentum的改进，有预判方向功能|
|<img src="./img/15/op_adagrad_ch04.png">|<img src="./img/15/op_adadelta_ch04.png">|
|AdaGrad的学习率在开始时可以设置大一些，因为会很快衰减|AdaDelta即使把学习率设置为0，也不会影响，因为有内置的学习率策略|
|<img src="./img/15/op_rmsprop_ch04.png">|<img src="./img/15/op_adam_ch04.png">|
